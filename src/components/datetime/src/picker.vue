    ...
    <div>
        ...
        <div class="yd-datetime" :class="show ? 'yd-datetime-active' : ''">
            <div class="yd-datetime-head">
                <a href="javascript:;" @click.stop="close">取消</a><a href="javascript:;" @click.stop="setValue">确定</a>
            </div>
...
<script type="text/babel">
    ...
    import {addClass, removeClass, getScrollview, isIOS, pageScroll} from './assist';
